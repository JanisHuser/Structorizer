...
$(document).ready(function() {
    ...
    $(document).on("change keyup keydown", ".informationDiv .information_content .informationContent .characteristicsDiv .characteristicsDivContent .singleCharacteristics.varNameinput", function(e) {
